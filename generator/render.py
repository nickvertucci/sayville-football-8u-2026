        ...
        for w in sorted(weeks):
            ...
            for p in weeks[w]:
                ...
                sections.append(
                    ...
                    f'<header><h4>{esc(title)}</h4><div class="tags">{tags}</div></header>'
                    f'<div class="grid">'
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  @media print {{
    ...
    .hero, nav, footer, h2.formation, h3.week, .formation-note {{ display: none; }}
...
{body}
<footer>
  <p>Generated by <code>generator/render.py</code>. Printing gives you the whole book in
  landscape, one play per sheet.</p>
</footer>
</div>
</html>
"""
