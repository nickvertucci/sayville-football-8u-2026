...
|---|---|---|---|---|
| [Split Formation - Z Right - 38 Toss](#split-formation---z-right---38-toss) | `Split Formation Z Right 38 Toss` | Toss | run | TB |
| [Split Formation - Z Left - 29 Toss](#split-formation---z-left---29-toss) | `Split Formation Z Left 29 Toss` | Toss | run | FB |
| [Split Formation - Z Right - 18 Sweep](#split-formation---z-right---18-sweep) | `Split Formation Z Right 18 Sweep` | Sweep | run | QB |
| [Split Formation - Z Left - 19 Sweep](#split-formation---z-left---19-sweep) | `Split Formation Z Left 19 Sweep` | Sweep | run | QB |
| [Split Formation - Z Left - 19 Fake Sweep](#split-formation---z-left---19-fake-sweep) | `Split Formation Z Left 19 Fake Sweep` | Sweep | run | QB |
| [Split Formation - Z Right - 18 Fake Sweep](#split-formation---z-right---18-fake-sweep) | `Split Formation Z Right 18 Fake Sweep` | Sweep | run | QB |
| [Split Formation - Z Right - Z Sweep Left](#split-formation---z-right---z-sweep-left) | `Split Formation Z Right Z Sweep Left` | Sweep | run | Z |
| [Split Formation - Z Left - Z Sweep Right](#split-formation---z-left---z-sweep-right) | `Split Formation Z Left Z Sweep Right` | Sweep | run | Z |
| [Split Formation - Z Right - X Sweep Right](#split-formation---z-right---x-sweep-right) | `Split Formation Z Right X Sweep Right` | Sweep | run | X |
| [Split Formation - Z Left - Y Sweep Left](#split-formation---z-left---y-sweep-left) | `Split Formation Z Left Y Sweep Left` | Sweep | run | Y |
| [Split Formation - Z Right - Y Slant Pass Right](#split-formation---z-right---y-slant-pass-right) | `Split Formation Z Right Y Slant Pass Right` | Protect | pass | Y |
| [Split Formation - Z Left - X Slant Pass Left](#split-formation---z-left---x-slant-pass-left) | `Split Formation Z Left X Slant Pass Left` | Protect | pass | X |
| [Split Formation - Z Right - 36 Handoff](#split-formation---z-right---36-handoff) | `Split Formation Z Right 36 Handoff` | Power | run | TB |
| [Split Formation - Z Left - 27 Handoff](#split-formation---z-left---27-handoff) | `Split Formation Z Left 27 Handoff` | Power | run | FB |
| [Split Formation - Z Right - 38 Toss Pass](#split-formation---z-right---38-toss-pass) | `Split Formation Z Right 38 Toss Pass` | Protect | pass | Y |
| [Split Formation - Z Left - 29 Toss Pass](#split-formation---z-left---29-toss-pass) | `Split Formation Z Left 29 Toss Pass` | Protect | pass | X |
...
![Split Formation - Z Right - 38 Toss](cards/sb-toss-r-4-4.svg)
...
![Split Formation - Z Left - 29 Toss](cards/sb-toss-l-4-4.svg)
...
![Split Formation - Z Right - 18 Sweep](cards/sb-qb-sweep-r-4-4.svg)
...
![Split Formation - Z Left - 19 Sweep](cards/sb-qb-sweep-l-4-4.svg)
...
![Split Formation - Z Left - 19 Fake Sweep](cards/sb-fake-sweep-l-4-4.svg)
...
![Split Formation - Z Right - 18 Fake Sweep](cards/sb-fake-sweep-r-4-4.svg)
...
![Split Formation - Z Right - Z Sweep Left](cards/sb-sl-sweep-l-4-4.svg)
...
![Split Formation - Z Left - Z Sweep Right](cards/sb-sl-sweep-r-4-4.svg)
...
![Split Formation - Z Right - X Sweep Right](cards/sb-te-sweep-r-4-4.svg)
...
![Split Formation - Z Left - Y Sweep Left](cards/sb-te-sweep-l-4-4.svg)
...
![Split Formation - Z Right - Y Slant Pass Right](cards/sb-te-out-r-4-4.svg)
...
![Split Formation - Z Left - X Slant Pass Left](cards/sb-te-out-l-4-4.svg)
...
![Split Formation - Z Right - 36 Handoff](cards/sb-power-r-4-4.svg)
...
![Split Formation - Z Left - 27 Handoff](cards/sb-power-l-4-4.svg)
...
![Split Formation - Z Right - 38 Toss Pass](cards/sb-toss-pass-r-4-4.svg)
...
![Split Formation - Z Left - 29 Toss Pass](cards/sb-toss-pass-l-4-4.svg)
