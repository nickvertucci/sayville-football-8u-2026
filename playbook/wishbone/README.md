...
Three backs in a Y behind the quarterback — fullback close at three yards, two backs split wider and deeper. Both ends are tight on the line. Perfectly symmetric, so every play has a left and right version with identical rules.
